...
class LiveclassCalendar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: StoreConnector<CalendarWidgetAppState, CalendarWidgetAppState>(
            converter: (store) => store.state,
            builder: (context, CalendarWidgetAppState state) => FutureBuilder<
                    bool>(
                                ...
                                builder: (context, selectedDay, _) {
                                  return TableCalendar(
                                    ...
                                    onDaySelected: (selectedDay, focusedDay) {
                                      if (!isSameDay(state.selectedDay.value,
                                          selectedDay)) {
