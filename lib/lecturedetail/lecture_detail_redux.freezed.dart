...
class _$LectureDetailAppStateImpl
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LectureDetailAppState(selectedItem: $selectedItem, question: $question, lectureData: $lectureData, query: $query)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, selectedItem,
      const DeepCollectionEquality().hash(question), lectureData, query);
